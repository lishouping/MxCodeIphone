...
@interface ManagerDishEditViewController ()<UITextFieldDelegate,UIScrollViewDelegate,UITableViewDelegate,UITableViewDataSource,UIImagePickerControllerDelegate>
{
    MBProgressHUD *hud;
...
@implementation ManagerDishEditViewController
...
- (void)makeUI{
    ...
    UILabel *labShopDd = [[UILabel alloc] initWithFrame:CGRectMake(15, 10+40+10+50+50+50+50+50+50, 80, 40)];
    [labShopDd setText:@"菜品销量"];
    labShopDd.font = [UIFont systemFontOfSize:13];
    [_scrollView addSubview:labShopDd];
    
    _tfShopAddress1 = [[UITextField alloc] initWithFrame:CGRectMake(15+80+10, 10+40+10+50+50+50+50+50+50, kWidth-15-80-10-15, 40)];
    _tfShopAddress1.placeholder = @"请输入菜品销量";
    _tfShopAddress1.delegate = self;
    [_tfShopAddress1 setTextColor:[UIColor blackColor]];
    ...
    UILabel *labShopH = [[UILabel alloc] initWithFrame:CGRectMake(15, 10+40+10+50+50+50+50+50+50+50, 80, 60)];
    [labShopH setText:@"菜品图片"];
    labShopH.font = [UIFont systemFontOfSize:13];
    [_scrollView addSubview:labShopH];
    
    imgLogo = [[UIImageView alloc] initWithFrame:CGRectMake(15+80+10, 10+40+10+50+50+50+50+50+50+50, 60, 60)];
    [_scrollView addSubview:imgLogo];
    
    btnAlLogo = [[UIButton alloc] initWithFrame:CGRectMake(15+80+10+60+10, 10+40+10+50+50+50+50+50+50+50, 60, 60)];
...
-(void)selectOnclick3{
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"选择菜品状态" message:nil preferredStyle:  UIAlertControllerStyleAlert];
    
    [alert addAction:[UIAlertAction actionWithTitle:@"下架" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        status = @"0";
        [tuiJianBtn setTitle:@"下架" forState:UIControlStateNormal];
        
    }]];
    [alert addAction:[UIAlertAction actionWithTitle:@"正常" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        status = @"1";
        [tuiJianBtn setTitle:@"正常" forState:UIControlStateNormal];
    }]];
...
-(void)sumbitClick{
    ...
    NSString *postUrl = [NSString stringWithFormat:@"%@%@",API_URL,UPDETEGOODS];
    NSDictionary *parameters = @{@"good_id":self.goods_id,
                                 @"shop_id":[userDefaults objectForKey:@"shop_id_MX"],
                                 ...
                                 @"if_alert":isalert,
                                 @"status":status,
                                 @"sales_count":_tfShopAddress1.text
                                 };
    AFHTTPRequestOperationManager *manager = [AFHTTPRequestOperationManager manager];
    manager.responseSerializer = [AFJSONResponseSerializer serializer];//使用这个将得到的是JSON
    manager.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/json",@"text/json", @"text/plain", @"text/html", nil];
    ...
    [manager POST:postUrl parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([[responseObject objectForKey:@"CODE"] isEqualToString:@"1000"]) {
           ...
           NSDictionary  *dic = [responseObject objectForKey:@"DATA"];
            ...
            status  = [[NSNumber numberWithLong:[ [dic objectForKey:@"status"]longValue]] stringValue];
            NSString *sales_count = [[NSNumber numberWithLong:[ [dic objectForKey:@"sales_count"]longValue]] stringValue];
            
            [_tfShopAddress1 setText:sales_count];
