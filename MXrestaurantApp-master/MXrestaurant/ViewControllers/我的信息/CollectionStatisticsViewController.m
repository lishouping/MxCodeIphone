...
@interface CollectionStatisticsViewController ()<UITableViewDelegate,UITableViewDataSource>{
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"收款统计";
...
- (void)selectgoodstatic{
    ...
    NSString *postUrl = [NSString stringWithFormat:@"%@%@",API_URL,GETCHECKSTATICS];
