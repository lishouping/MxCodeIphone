...
- (void)makUI{
    self.vieNum = [[UIView alloc] initWithFrame:CGRectMake(10, 5, 20, 20)];
    [self.vieNum setBackgroundColor:[UIColor colorWithRed:182.0/255.0 green:182.0/255.0 blue:182.0/255.0 alpha:1]];
    self.vieNum.layer.cornerRadius = 10;
    [self.contentView addSubview:self.vieNum];
    
    self.labNum = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 20, 20)];
    [self.labNum setTextColor:[UIColor whiteColor]];
    [self.labNum setFont:[UIFont systemFontOfSize:10]];
    self.labNum.textAlignment = UITextAlignmentCenter;
    [self.vieNum addSubview:self.labNum];
    
    self.labFoodName = [[UILabel alloc] initWithFrame:CGRectMake(10+20+10+5, 5, kWidth/2-20, 20)];
    [self.labFoodName setFont:[UIFont systemFontOfSize:12]];
    [self.contentView addSubview:self.labFoodName];
    
    self.labStatisNum = [[UILabel alloc] initWithFrame:CGRectMake(kWidth/2-20, 0, kWidth/2/2, 20)];
    ...
    self.labTotalPrice = [[UILabel alloc] initWithFrame:CGRectMake(kWidth-10-100, 5, 100, 20)];
